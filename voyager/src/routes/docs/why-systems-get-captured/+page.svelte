...
<svelte:head>
	<title>Why a capturable system invites capture — Voyager docs</title>
</svelte:head>
...
<section class="pt-4 pb-12">
	...
	<p class="mt-6 max-w-2xl text-lg leading-relaxed text-ink-2">
		Concentrated, visible, separable value is an open invitation. The moment a system has all three — the loot sits in one place, an outsider can see it, and they can walk off with it — an EROI budget at or above one is waiting to be spent. The only durable answer is to make the crime not worth the squeeze.
	</p>
</section>
...
<section class="pb-12">
	<div class="flex flex-col gap-6 text-[17px] leading-relaxed text-ink-2">
		...
		<p>
			Now spread the same total cash across thousands of small balances belonging to different people in different places. Find cost rises: no address publishes them all. Reach cost rises: you would need many separate compromises. Hold cost rises: you cannot be at all of them at once. Move cost rises: each withdrawal is small and individually suspicious. Same total value. Much higher capture cost.
		</p>
		<p>
			<strong class="text-ink">A bearer bond vs. a relationship-bound contract.</strong> A bearer bond is separable: whoever holds it owns it. Move cost is near zero. Transfer it. Walk away.
		</p>
		<p>
		...
		<div class="rounded-[24px] bg-bone-100 p-6 mt-4">
			...
			<p class="mt-2">
				...
				the budget is too small to spend.
			</p>
		</div>
	</div>
</section>
