...
<section class="pt-4 pb-12">
	...
	<p class="mt-6 max-w-2xl text-lg leading-relaxed text-ink-2">
		A federation of independent Mostro nodes competes on rate, fee, and reputation. The §7.4 rubric is the client-side mechanism that turns that competition into the prices the customer actually sees. This lesson walks through the rubric, the weights, and why the rubric biases toward honest operators.
	</p>
</section>

<section class="pb-12">
	<div class="flex flex-col gap-6 text-[17px] leading-relaxed text-ink-2">
		<h2 class="font-display text-2xl text-ink mt-4">The three things that compete</h2>
		<p>
			When a customer's wallet opens with an amount, a fiat, and a method, it reads every reachable Mostro node's <code class="rounded bg-bone-200 px-1.5 py-0.5 text-[15px]">kind:38383</code> profile, filters by fiat and method, and ranks the survivors on three signals:
		</p>
		...
		<h2 class="font-display text-2xl text-ink mt-4">The weights</h2>
		<p>
			The reference client's <code class="rounded bg-bone-200 px-1.5 py-0.5 text-[15px]">rankQuotes</code> module — a deterministic stand-in for the spec's §7.4 rubric — combines the three signals with these weights:
		</p>
		<div class="rounded-[28px] bg-bone-100 p-6 mt-2">
		...
		<h2 class="font-display text-2xl text-ink mt-4">Why the weights bias toward honest operators</h2>
		<p>
		...
		<h2 class="font-display text-2xl text-ink mt-4">Why a single node cannot persistently undercut</h2>
		<p>
		...
		<h2 class="font-display text-2xl text-ink mt-4">Why fees trend toward cost-plus-margin</h2>
		<p>
		...
		<p>
			That is the structural answer. The customer-side UI is one widget reading one fixture. The mechanism behind it is the rubric.
		</p>
