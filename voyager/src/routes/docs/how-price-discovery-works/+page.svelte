...
<section>
	<h2 id="biases-honest-operators">Why this biases toward honest operators</h2>
...
<section>
	<h2 id="single-node-cannot-undercut">Why a single node cannot persistently undercut</h2>
...
<section>
	<p>Continue to <a href="/docs/how-voyager-pay-extends">How Voyager Pay extends</a>.</p>
</section>
