...
<section class="mx-auto max-w-6xl px-6 pb-20">
	<SoundSystemStrip register="rasta" eyebrow="Sound systems · Mostro federation" systems={SOUND_SYSTEMS} />
	<div class="mt-10">
		<HeritageLineage register="rasta" eyebrow="Platform lineage" stages={LINEAGE} caption="Advisory call → primitives → open rails — the same lineage shape, adapted to software." />
	</div>
</section>
</RegisterSection>
