  ...
  "properties": {
    ...
    "tags": {
      ...
      "contains": {
        "type": "array",
        "minItems": 2,
        "prefixItems": [{ "const": "d" }, { "type": "string", "minLength": 1 }]
      }
    }
  },
  "allOf": [
        ...
        "tags": {
          "allOf": [
            ...
            },
            {
              "contains": {
                "type": "array",
                "prefixItems": [{ "const": "title" }, { "type": "string" }]
              }
            },
            {
              "contains": {
...
```json
{
  ...
  "allOf": [{ "description": "MUST include d and name" }]
}
```
